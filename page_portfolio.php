						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloOne" rel="modal:open">
								<img
									...
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/1.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloTwo" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/2.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloThree" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/3.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloFour" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/4.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloFive" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/5.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloSix" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/6.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloSeven" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/7.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloEight" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/8.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
					...
					<div
						...
						<div class="overflow-hidden rounded-lg">
							<a href="#portfiloNine" rel="modal:open">
								<img
									class="w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110 rounded-lg h-auto"
									src="<?php echo get_template_directory_uri(); ?>/images/work_images/small/9.jpg"
									alt="portfolio image"/>
							</a>
						</div>
						<span
