<div class="bg-white lg:rounded-2xl dark:bg-[#111111]">
	<div
		...
		<h3 class="text-4xl">
			<?php if ( $text = get_option( 'bostami_contact_text' ) ) { ?>
				<span class="text-gray-lite dark:text-[#A6A6A6]"><?php echo $text; ?></span>
			<?php } else { ?>
		...
		<form action="https://formspree.io/f/mrgnjyeg" method="POST">
