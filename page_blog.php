...
?>
		...
		<div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
			<div class="pr-3 pb-2">
				<img class="w-full md:h-[450px] object-cover rounded-xl mt-6"
				     src="<?php echo get_template_directory_uri(); ?>/images/blog_images/1.jpg"
				     alt="blog image"/>
			...
			<div class="rounded-lg mt-6 bg-gradient-to-r from-[#FA5252] to-[#DD2476] p-[1px] mr-3">
				<div class="dark:bg-[#232220] bg-[#ffffff] flex p-4 rounded-lg">
					<div>
						<img class="md:w-[125px] rounded-xl"
						     src="<?php echo get_template_directory_uri(); ?>/images/about/about.jpg" alt="blog image"/>
					</div>
					<div class="pl-5">
						...
						<button
							class="dark:text-[#dedede] text-tiny hover:text-[#FA5252] dark:hover:text-[#FA5252]">Reply
						</button>
					</div>
				</div>
			</div>
	...
	<div id="ex2" class="modal-container modal">
		<div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
			<div class="pr-3 pb-2">
				<img class="w-full md:h-[450px] object-cover rounded-xl mt-6"
				     src="<?php echo get_template_directory_uri(); ?>/images/blog_images/2.jpg"
				     alt="blog image"/>
				<div class="flex mt-4 text-tiny text-black dark:text-white">
					<span>10 April</span>
					<span class="dot-icon">Inspiration</span>
	...
	<div id="ex3" class="modal-container modal">
		<div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
			<div class="pr-3 pb-2">
				<img class="w-full md:h-[450px] object-cover rounded-xl mt-6"
				     src="<?php echo get_template_directory_uri(); ?>/images/blog_images/3.jpg"
				     alt="blog image"/>
				<div class="flex mt-4 text-tiny text-black dark:text-white">
					<span>07 April</span>
					<span class="dot-icon">Inspiration</span>
	...
	<div id="ex4" class="modal-container modal">
		<div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
			<div class="pr-3 pb-2">
				<img class="w-full md:h-[450px] object-cover rounded-xl mt-6"
				     src="<?php echo get_template_directory_uri(); ?>/images/blog_images/4.jpg"
				     alt="blog image"/>
				<div class="flex mt-4 text-tiny text-black dark:text-white">
					<span>177 April</span>
					<span class="dot-icon">Inspiration</span>
