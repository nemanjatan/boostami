			...
			<div class="pt-12 md:py-12 px-2 sm:px-5 md:px-10 lg:px-14">
				...
				<div class="lg:hidden">
					<div
						...
						<!-- profile image  -->
						<img src="<?php echo get_template_directory_uri(); ?>/images/about/avatar.jpg"
				...
				<div class="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
					<div class="about-box bg-[#fcf4ff] dark:bg-transparent">
						<img class="w-10 h-10 object-contain block"
						     src="<?php echo get_template_directory_uri(); ?>/images/icons/icon.svg"
						     alt="icon"/>
						<div class="space-y-2">
					...
					<div class="about-box bg-[#fefaf0] dark:bg-transparent">
						<img class="w-10 h-10 object-contain block"
						     src="<?php echo get_template_directory_uri(); ?>/images/icons/icon1.svg"
						     alt="icon"/>
						<div class="space-y-2">
					...
					<div class="about-box bg-[#fcf4ff] dark:bg-transparent">
						<img class="w-10 h-10 object-contain block"
						     src="<?php echo get_template_directory_uri(); ?>/images/icons/icon2.svg"
						     alt="icon"/>
						<div class="space-y-2">
					...
					<div class="about-box bg-[#fff4f4] dark:bg-transparent">
						<img class="w-10 h-10 object-contain block"
						     src="<?php echo get_template_directory_uri(); ?>/images/icons/icon3.svg"
						     alt="icon"/>
						<div class="space-y-2">
							<h3 class="dark:text-white text-[22px] font-semibold"> Photography </h3>
							<p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> Lorem ipsum dolor sit
					...
					<div class="about-box bg-[#fff0f8] dark:bg-transparent">
						<img class="w-10 h-10 object-contain block"
						     src="<?php echo get_template_directory_uri(); ?>/images/icons/icon4.svg"
						     alt="icon"/>
						<div class="space-y-2">
					...
					<div class="about-box bg-[#f3faff] dark:bg-transparent">
						<img class="w-10 h-10 object-contain block"
						     src="<?php echo get_template_directory_uri(); ?>/images/icons/icon5.svg"
						     alt="icon"/>
						<div class="space-y-2">
					...
					<div class="slickOne text-center px-2 pt-8">
						<div>
							<img class="overflow-hidden brand-img"
							     src="<?php echo get_template_directory_uri(); ?>/images/slider/brand.png"
							     alt="brand icon"/>
						</div>
						<div>
							<img class="overflow-hidden brand-img"
							     src="<?php echo get_template_directory_uri(); ?>/images/slider/brand1.png"
							     alt="brand icon"/>
						</div>
						<div>
							<img class="overflow-hidden brand-img"
							     src="<?php echo get_template_directory_uri(); ?>/images/slider/brand2.png"
							     alt="brand icon"/>
						</div>
						<div>
							<img class="overflow-hidden brand-img"
							     src="<?php echo get_template_directory_uri(); ?>/images/slider/brand3.png"
							     alt="brand icon"/>
						</div>
						<div>
							<img class="overflow-hidden brand-img"
							     src="<?php echo get_template_directory_uri(); ?>/images/slider/brand4.png"
							     alt="brand icon"/>
						</div>
						<div>
							<img class="overflow-hidden brand-img"
